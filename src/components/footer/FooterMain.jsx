...
// This component renders the footer of my portfolio website.
// It includes my name and quick navigation links to different sections of the page for larger screen.
...
const FooterMain = () => {
  return (
    <div className="px-4 py-8 mt-32">
      <div className="w-full h-[2px] bg-white mt-60"></div>
