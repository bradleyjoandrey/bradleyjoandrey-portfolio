...
// This component displays the hero image (me) with an animated background circle effect.
...
const HeroPic = () => {
  return (
    ...
    >
      <img
        src={`${import.meta.env.BASE_URL}images/HeroImage.png`}
        alt="Bradley Joandrey"
