...
const certificates = [
    {
        ...
        publicLink: 'https://www.credly.com/badges/ea6cb775-cc62-4e66-882a-617894549366/public_url',
    },
    {
        ...
        publicLink: 'https://www.credly.com/badges/80881a27-de42-4bb5-8e04-58923f30d402/public_url',
    },
]
    ...
    <div id='certificates' className='max-w-[1200px] mx-auto px-4 mt-24'>
      ...
      <div className='flex flex-wrap justify-center gap-8 mt-10'>
        {certificates.map((cert, index) => (
          <SingleCertificate key={index} name={cert.name} embedCode={cert.embedCode} publicLink={cert.publicLink}/>
        ))}
      </div>
    </div>
  );
